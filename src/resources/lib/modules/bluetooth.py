...
class bluetooth:
    ...
    def open_pinkey_window(self, runtime=60, title=32343):
        try:
            ...
            self.pinkey_window = oeWindows.pinkeyWindow('service-AlexELEC-Settings-getPasskey.xml', self.oe.__cwd__, 'Default')
            ...
            try:
                ...
                if 'Status' in interface:
                    if interface['Status'] == 'active':
                        ...
                        self.parent.download.create('AlexELEC Bluetooth Filetransfer', '%s: %s' % (self.oe._(32181).encode('utf-8'),
                        ...
                        if interface['Status'] == 'complete':
                            ...
                            answer = xbmcDialog.yesno('AlexELEC Bluetooth Filetransfer', self.oe._(32383).encode('utf-8'))
                            if answer == 1:
...
class bluetoothAgent(dbus.service.Object):
    ...
    def AuthorizeService(self, device, uuid):
        try:
            ...
            self.oe.dbg_log('bluetooth::btAgent::AuthorizeService', 'enter_function', 0)
            xbmcDialog = xbmcgui.Dialog()
            answer = xbmcDialog.yesno('AlexELEC Bluetooth', 'AuthorizeService')
            if answer == 1:
    ...
    def RequestConfirmation(self, device, passkey):
        try:
            ...
            xbmcDialog = xbmcgui.Dialog()
            answer = xbmcDialog.yesno('AlexELEC Bluetooth', 'RequestConfirmation', unicode(passkey))
    ...
    def RequestAuthorization(self, device):
        try:
            ...
            xbmcDialog = xbmcgui.Dialog()
            answer = xbmcDialog.yesno('AlexELEC Bluetooth', 'RequestAuthorization')
            if hasattr(self.parent, 'pinkey_window'):
...
class obexAgent(dbus.service.Object):
    ...
    def AuthorizePush(self, path):
        try:
            ...
            xbmcDialog = xbmcgui.Dialog()
            answer = xbmcDialog.yesno('AlexELEC Bluetooth', self.oe._(32381), properties['Name'])
            if answer != 1:
